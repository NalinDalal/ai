"""
main.py - RNN Character-Level Language Model
Based on d2l.ai RNN implementation

This demo trains an RNN to predict the next character in a sequence.
"""
...
def main():
    ...
    rnn = RNNLayer(vocab_size, n_hidden)
    ...
    for epoch in range(1, epochs + 1):
        ...
        for i in indices:
            ...
            rnn.backward_sequence(doutput)

            clip_gradients(
                {
                    "dW_xh": rnn.cell.dW_xh,
                    "dW_hh": rnn.cell.dW_hh,
                    "dW_hy": rnn.cell.dW_hy,
                },
                grad_clip,
            )
    ...
    for prefix in ["hello", "world", "llo w"]:
        result = list(prefix)
        rnn.cell.h = np.zeros((n_hidden, 1))
